...
```
<DIRECCIÓN> XX XX XX XX XX XX ... (16 veces)
```
...
Es requisito indispensable presentar un reporte en formado digital con:
- Copia legible de identificación con fotografía (credencial del estudiante)
- Breve (1 hoja) REPORTE DONDE SE EXPLIQUEN LOS CRITERIOS DE DISEÑO Y LA ESTRUCTURA que guarda

## Puntos extra
- [ ] Generar un archivo con el listado mostrando una diferencia de color entre los códigos de instrucción y los operandos que conforman el código objeto (*1 punto*)
